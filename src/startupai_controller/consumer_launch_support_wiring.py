...
def prepare_worktree(
    ...
    *,
    ...
    list_repo_worktrees: Callable[..., Any],
    ...
    return _prepare_worktree_helper(
        ...
        list_repo_worktrees=list_repo_worktrees,
        worktree_is_clean=worktree_is_clean,
        worktree_ownership_is_safe=worktree_ownership_is_safe,
...
def setup_launch_worktree(
    ...
    *,
    ...
    return _setup_launch_worktree_helper(
        ...
        worktree_error_cls=worktree_error_cls,
        session_store=session_store,
        worktree_port=worktree_port,
        subprocess_runner=subprocess_runner,
...
def resolve_launch_candidate_metadata(
    ...
    *,
    ...
    classify_open_pr_candidates: Callable[..., Any],
    ...
    return _resolve_launch_candidate_metadata_helper(
        ...
        snapshot_for_issue=snapshot_for_issue,
        classify_open_pr_candidates=classify_open_pr_candidates,
        launch_session_kind=launch_session_kind,
    )
...
def resolve_launch_issue_context(
    ...
    *,
    ...
    return _resolve_launch_issue_context_helper(
        ...
        gh_runner=gh_runner,
        hydrate_issue_context=hydrate_issue_context,
    )
...
def run_launch_workspace_hooks(
    ...
    *,
    ...
    _run_launch_workspace_hooks_helper(
        ...
        worktree_port=worktree_port,
        subprocess_runner=subprocess_runner,
        run_workspace_hooks=run_workspace_hooks,
    )
